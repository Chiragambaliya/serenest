    ...
    <div className="eda-page">
      ...
      <section className="eda-hero eda-hero--simple">
        <div className="container">
          <div className="eda-hero-body">
            ...
            <div className="eda-hero-photo" role="img" aria-label="Placeholder — needs real photography: books and a handwritten notebook on a desk">
              <span className="eda-hero-photo__label">Photography needed</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="why" className="eda-section">
        <div className="container eda-why-split">
          ...
          <div className="eda-why-photo" role="img" aria-label="Placeholder — needs real photography: a consultation or teaching room">
            <span className="eda-hero-photo__label">Photography needed</span>
