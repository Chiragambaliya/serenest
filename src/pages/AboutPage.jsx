...
const PLATFORM = [
  ...
  },
  {
    ...
    body: 'Plain-language explainers on the same site — understanding alongside care.',
  },
];
      ...
      <section className="abt-section ed-pace" id="platform">
        <div className="container">
          <div className="ed-head ed-measure-wide">
            ...
            <p>Scheduling, sessions, documentation, prescriptions, and patient guides — together.</p>
          </div>
