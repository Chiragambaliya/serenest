...
export default function ProfessionalOnboardingPage() {
  ...
  const subject = encodeURIComponent(`Professional onboarding: ${roleLabel}`);
            ...
            {step === 2 && (
              <div className="booking-body">
                <div className="section-head" style={{ marginBottom: 10 }}>
                  ...
                  <h2>Credentials</h2>
                  <p>We verify credentials before you go live.</p>
                </div>
              ...
              <div className="booking-body">
                ...
                <div className="booking-actions">
                  ...
                  <a
                    ...
                    href={`mailto:support@serenest.fit?subject=${subject}&body=${body}`}
