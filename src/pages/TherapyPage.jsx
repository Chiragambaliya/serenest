    ...
    <div className="svd-page">
      ...
      <section className="svd-section svd-section--soft">
        <div className="container">
          ...
          <h2 style={{ fontSize: '1.3rem', marginTop: '2.5rem' }}>Approaches used on Serenest</h2>
          <p className="svd-section-lead" style={{ marginTop: 0, marginBottom: '1.5rem' }}>
            Not every therapist uses every approach below — we match you to someone whose
            experience fits.
          </p>
          <ul className="svd-list">
            {APPROACHES.map((item) => (
      ...
      <section className="svd-section">
        <div className="container">
          ...
          <h2 style={{ fontSize: '1.3rem', marginTop: '2.5rem' }}>Confidentiality and boundaries</h2>
