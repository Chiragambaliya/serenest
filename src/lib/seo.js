...
import { ACADEMY_FAQS } from './academyFaqs.js';
...
export const ROUTE_SEO = {
  ...
  '/academy/programs': {
    title: 'Academy Programs | Clinical Courses for Mental Health Professionals',
    description:
      'The full Serenest Academy catalogue — clinical excellence, student training, counselling skills, psychiatry, CPD, and fellowships for mental health professionals in India.',
    ogTitle: 'Serenest Academy Programs',
    ogDescription:
      'Browse every Serenest Academy program for psychologists, psychiatrists, counsellors, and trainees.',
  },
  '/academy/learning-paths': {
    title: 'Academy Learning Paths | Sequences by Career Stage | Serenest',
    description:
      'Suggested Serenest Academy program sequences for students, early-career clinicians, and practising psychiatrists and psychologists.',
    ogTitle: 'Serenest Academy Learning Paths',
    ogDescription:
      'Program sequences for foundation, core practice, applied skills, and advanced clinical work.',
  },
  '/academy/workshops': {
    title: 'Academy Workshops | Live Clinical Teaching | Serenest',
    description:
      'Live and recorded workshops from Serenest Academy for psychiatrists, psychologists, and counsellors in India.',
    ogTitle: 'Serenest Academy Workshops',
    ogDescription:
      'Short intensives and live teaching from Serenest Academy — dates published when scheduled.',
  },
  '/academy/faculty': {
    title: 'Academy Faculty | Clinicians Who Teach | Serenest',
    description:
      'Meet the clinicians teaching Serenest Academy programs, and how to apply to teach mental health professionals in India.',
    ogTitle: 'Serenest Academy Faculty',
    ogDescription:
      'Clinician-teachers at Serenest Academy — and how to apply to join the faculty.',
  },
  '/academy/resources': {
    title: 'Academy Resources | Guides & Practice Tools | Serenest',
    description:
      'Clinical guides, reading lists, and practice tools from Serenest Academy for learners and faculty.',
    ogTitle: 'Serenest Academy Resources',
    ogDescription:
      'Guides, reading lists, and practice tools organised for Academy learners and faculty.',
  },
  '/academy/faqs': {
    title: 'Academy FAQs | Enrolment, Certificates & Access | Serenest',
    description:
      'Frequently asked questions about Serenest Academy programs, certificates, delivery, and enrolment for mental health professionals.',
    ogTitle: 'Serenest Academy FAQs',
    ogDescription:
      'Answers on who Academy is for, certificates, delivery, duration, and professional access.',
  },
  '/professionals': {
  ...
  '/contact': {
    ...
    description:
      'Get in touch with Serenest for patient support, appointment help, billing questions, Academy questions, or professional and institutional collaboration.',
    ogTitle: 'Contact Serenest',
    ogDescription:
      'Patient support, appointment help, Academy questions, and professional collaboration — reach the Serenest team.',
  },
  '/corporate': {
...
for (const program of ACADEMY_PROGRAMS) {
  ROUTE_SEO[`/academy/programs/${program.slug}`] = {
    ...
    description: program.tagline || program.body,
...
export const ROUTE_ALIASES = {
  ...
  // Retired reading URL and Academy learn hub → current destinations
  '/resources': '/blog',
  ...
  // Singular /academy/program/:slug was the old catalogue URL
  ...Object.fromEntries(
    ACADEMY_PROGRAMS.map((p) => [`/academy/program/${p.slug}`, `/academy/programs/${p.slug}`]),
  ),
};
...
export const ROUTE_JSONLD = {
  ...
  '/academy/programs': {
    ...
    '@graph': [
      ...
      {
        '@type': 'CollectionPage',
        '@id': `${SITE_ORIGIN}/academy/programs#webpage`,
        url: `${SITE_ORIGIN}/academy/programs`,
        name: 'Serenest Academy Programs',
        description:
          'The full Serenest Academy catalogue for psychology students, counsellors, psychiatrists, and mental health professionals.',
        inLanguage: 'en-IN',
      },
      breadcrumbs('/academy/programs', 'Programs', [{ name: 'Academy', item: `${SITE_ORIGIN}/academy` }]),
    ],
  },
  '/academy/learning-paths': {
    '@context': 'https://schema.org',
    '@graph': [
      ORG_SCHEMA,
      WEBSITE_SCHEMA,
      breadcrumbs('/academy/learning-paths', 'Learning Paths', [{ name: 'Academy', item: `${SITE_ORIGIN}/academy` }]),
    ],
  },
  '/academy/workshops': {
    '@context': 'https://schema.org',
    '@graph': [
      ORG_SCHEMA,
      WEBSITE_SCHEMA,
      breadcrumbs('/academy/workshops', 'Workshops', [{ name: 'Academy', item: `${SITE_ORIGIN}/academy` }]),
    ],
  },
  '/academy/faculty': {
    '@context': 'https://schema.org',
    '@graph': [
      ORG_SCHEMA,
      WEBSITE_SCHEMA,
      breadcrumbs('/academy/faculty', 'Faculty', [{ name: 'Academy', item: `${SITE_ORIGIN}/academy` }]),
    ],
  },
  '/academy/resources': {
    '@context': 'https://schema.org',
    '@graph': [
      ORG_SCHEMA,
      WEBSITE_SCHEMA,
      breadcrumbs('/academy/resources', 'Resources', [{ name: 'Academy', item: `${SITE_ORIGIN}/academy` }]),
    ],
  },
  '/academy/faqs': {
    '@context': 'https://schema.org',
    '@graph': [
      ...
      {
        '@type': 'FAQPage',
        '@id': `${SITE_ORIGIN}/academy/faqs#faq`,
        url: `${SITE_ORIGIN}/academy/faqs`,
        mainEntity: ACADEMY_FAQS.map((f) => ({
          '@type': 'Question',
          name: f.question,
          acceptedAnswer: { '@type': 'Answer', text: f.answer },
        })),
      },
      breadcrumbs('/academy/faqs', 'Academy FAQs', [{ name: 'Academy', item: `${SITE_ORIGIN}/academy` }]),
    ],
  },
  '/professionals': {
    '@context': 'https://schema.org',
  ...
  '/contact': {
    ...
    '@graph': [
      ...
      WEBSITE_SCHEMA,
      {
        ...
        description:
          'Patient support, appointment help, billing questions, Academy questions, and professional collaboration — reach the Serenest team.',
        inLanguage: 'en-IN',
        isPartOf: { '@id': `${SITE_ORIGIN}/#website` },
      },
...
for (const program of ACADEMY_PROGRAMS) {
  const path = `/academy/programs/${program.slug}`;
  ROUTE_JSONLD[path] = {
    '@context': 'https://schema.org',
    '@graph': [
      ORG_SCHEMA,
      WEBSITE_SCHEMA,
      {
        ...
        about: program.category ? [program.category] : ['Mental health education'],
      },
      breadcrumbs(path, program.title, [
