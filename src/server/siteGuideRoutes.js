...
export const SITE_GUIDE_ROUTES = [
  ...
  { path: '/online-psychiatrist-consultation-india', label: 'Online psychiatrist consultation in India (landing)' },
  ...
  { path: '/online-psychiatrist-gujarat', label: 'Online psychiatrist for Gujarat' },
